...
const cardMeanings = [
  {
    ...
    keywords: ["быт", "семейный отдых", "неожиданность"],
    meaning: "Внуки утонут на отдыхе."
  },
  {
    id: 2,
    title: "Енот на машине",
    keywords: ["дорога", "семья", "опасность"],
  ...
  },
  {
    ...
    keywords: ["неожиданный визит", "дом", "тревога"],
    meaning: "Завтра к матери домой прилетает шахед."
  },
  {
    id: 5,
    title: "Конь с удочкой",
    keywords: ["потеря", "наследие", "тишина"],
    meaning: "Смерть всех детей."
  },
  {
    id: 6,
    title: "Белка плавает",
    keywords: ["здоровье", "испытание", "время"],
  ...
  },
  {
    ...
    keywords: ["неизбежность", "рок", "утрата"],
    meaning: "Вся родня умрёт от гепатита C, Ваша мама будет мучиться в вагоне, и умрёт. Смерть всей вашей семьи от бомбардировки неизбежна."
  }
];
