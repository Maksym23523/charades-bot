...
const cardMeanings = [
  ...
  {
    id: 25,
    title: "Бобёр-бейсболист",
    meaning: "Пророчит успех, величие и славу, но вдобавок — смерть всей родни в результате несчастного случая."
  },
  {
    id: 26,
    title: "Змейка на волне",
    meaning: "Скоро отпуск, океан, сёрфинг, но, пока вы этим занимаетесь, дети захлебнутся на пляже."
  }
];
